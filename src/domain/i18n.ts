...
const STRINGS: Dict = {
  ...
  'onboard.motivation': { ru: 'XP и серии', en: 'XP and streaks' },
  'onboard.motivationDesc': {
    ru: 'Зарабатывайте XP, выполняйте миссии и не прерывайте серию.',
    en: 'Earn XP, complete missions and keep your streak.',
  },
